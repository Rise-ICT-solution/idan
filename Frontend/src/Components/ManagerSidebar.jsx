...
function ManagerSidebar (){
    return <div className="bg-[#008081] fixed   sm:h-screen  sm:block flex mb-[400px]  justify-between px-[15px] sm:px-0 items-center  top-0  sm:pt-4  w-full sm:w-[16%]  ">
        ...
        <div className="sm:block flex items-center sm:mt-10 px-[10px]">
            ...
            <Link to="/totalAdmins">
                <div className="flex gap-2 items-center mt-5 hover:bg-[#0E0E0E] h-[40px] rounded-[10px] ">
