...
function WorkerRejectedRequests (){
    ...
    return <div className="w-full h-screen bg-lightBlue">
        <WorkerHeader />
        <div className="ml-12">
            <h1 className=" text-center text-3xl font-semibold text-[#3b3832] pt-[6%]"> Worker Rejected Requests </h1>
                    ...
                    <tbody className="bg-white">
                        {
                            ...
                            <td className="p-3 border text-center border-gray-500"> {requestInfo.name} </td>
